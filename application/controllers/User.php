...
class User extends CI_Controller 
{
	...
	*/
	...
	//query
	var $ordQuery=" ORDER BY id_user ";
	var $tableQuery="
						user
						";
	var $fieldQuery="id_user,user_name,email,password,hak_akses,nama_lengkap,alamat,no_telepon"; //leave blank to show all field
						
	var $primaryKey="id_user";
	var $updateKey="id_user";
	
	//auto generate id
	var $defaultId="U0000001";
	var $prefix="U";
	var $suffix="0000001";	
	...
	*/
	...
	public function add($isEdit="")
	{
		...
		$output['formTxt']=array(
								...
								"<input type='text' class='form-control' id='txtid0' name=txt[] value='".$txtVal[2]."' maxlength='40' required>",
								"<input type='text' class='form-control' id='txtid0' name=txt[] value='".$txtVal[3]."' maxlength='32' required>",
								"<input type='text' class='form-control' id='txtid1' name=txt[] value='".$txtVal[4]."' required>",
								"<input type='text' class='form-control' id='txtid0' name=txt[] value='".$txtVal[5]."' maxlength='40' required>",
								"<input type='text' class='form-control' id='txtid1' name=txt[] value='".$txtVal[6]."' required>",
								"<input type='text' class='form-control' id='txtid0' name=txt[] value='".$txtVal[7]."' maxlength='15' required>"
								);
