...
class Barang extends CI_Controller 
{
	...
	*/
	...
	var $mainTable="barang";
	var $mainPk="id_barang";
	var $viewLink="Barang";
	
	var $breadcrumbTitle="Daftar Barang";
	...
	//query
	var $ordQuery=" ORDER BY nama_barang ";
	var $tableQuery="
						barang
						";
	var $fieldQuery="id_barang,nama_barang,id_jenis,harga,stok,foto"; //leave blank to show all field
	...
	*/
	...
	public function add($isEdit="")
	{
		...
		$output['formTxt']=array(
								...
								"<input type='text' class='form-control' id='txtid1' name=txt[] value='".$txtVal[1]."' maxlength='20' required>",
