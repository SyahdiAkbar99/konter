      ...
      <aside class="main-sidebar">
        <section class="sidebar">
          <ul class="sidebar-menu">
			...
			<!-- menu -->
			<li class="treeview">
				<a href="#"><i class="fa fa-user text-red"></i><span>Master</span> <i class="fa fa-angle-left pull-right"></i></a>
				<ul class="treeview-menu">		
					<li><a href="<?= site_url();?>Barang"><i class="fa fa-user text-yellow"></i> <span>Barang</span></a></li> 
          <li><a href="<?= site_url();?>Jenis"><i class="fa fa-user text-yellow"></i> <span>Jenis</span></a></li>
          <li><a href="<?= site_url();?>User"><i class="fa fa-user text-yellow"></i> <span>User</span></a></li>
				</ul>
			</li>

          <!-- menu -->
      <li class="treeview">
        <a href="#"><i class="fa fa-user text-red"></i><span>Transaksi</span> <i class="fa fa-angle-left pull-right"></i></a>
        <ul class="treeview-menu">    
          <li><a href="<?= site_url();?>Beli"><i class="fa fa-user text-yellow"></i> <span>Beli</span></a></li> 
          <li><a href="<?= site_url();?>Jual"><i class="fa fa-user text-yellow"></i> <span>Jual</span></a></li> 
          <li><a href="<?= site_url();?>Keranjang"><i class="fa fa-user text-yellow"></i> <span>Keranjang</span></a></li> 
        </ul>
      </li>
