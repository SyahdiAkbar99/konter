                        ...
                        <div class="col-lg-12">
                            <ul class="nav nav-tabs ml-5 mr-5 justify-content-center" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#penjual" role="tab" aria-controls="penjual" aria-selected="true">Registrasi Penjual</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#pembeli" role="tab" aria-controls="pembeli" aria-selected="false">Registrasi Pembeli</a>
                                </li>
                            </ul>
